...
- **Access:** [The Cancer Imaging Archive - ISPY2 Collection](https://www.cancerimagingarchive.net/collection/ispy2/)  
- **Total Patients:** **985**  
  - **719** I-SPY2 cases  
...
note: **Segmentation masks are stored as 2D DICOM images** aligned with the original **DCE MRI scans**.  
...
Metadata for ISPY1 is stored in `ispy1_dce_series_info.xlsx` with 221 patients. This dataset contains MRI series metadata for each patient, including:  
...
Metadata for ISPY2 was extracted from `series-data1741883133411.csv` with 719 patients.  
- **Subject.ID**
- **Study.Description** exmaple "ISPY2_MRI_T0" "ISPY2_MRI_T0" "ISPY2_MRI_T0" "ISPY2_MRI_T0" "ISPY2_MRI_T0" "ISPY2_MRI_T0"
-**"Number.of.images**: "MR"  "SEG"
